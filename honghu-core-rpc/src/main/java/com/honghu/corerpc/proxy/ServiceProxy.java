...
import com.honghu.corerpc.fault.retry.RetryStrategyFactory;
import com.honghu.corerpc.fault.tolerant.TolerantStrategy;
import com.honghu.corerpc.fault.tolerant.TolerantStrategyFactory;
import com.honghu.corerpc.loadbalance.LoadBalanceFactory;
import com.honghu.corerpc.loadbalance.LoadBalancer;
...
import com.honghu.corerpc.server.tcp.VertxTcpClient;
...
public class ServiceProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        //负载均衡
        LoadBalancer loadBalancer = LoadBalanceFactory.getInstance(rpcConfig.getLoadBalance());
